...
func (suite *ClusterMachineConfigSuite) registerControllers() {
	...
	suite.Require().NoError(suite.runtime.RegisterQController(omnictrl.NewClusterMachineConfigController(imageFactoryHost, nil, "ghcr.io/siderolabs/installer", conf.Registries{}, nil)))
